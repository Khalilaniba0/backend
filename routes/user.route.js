...
router.get('/getAll', requireAuth, requireAdmin, logMiddleware, userController.getAllUsers);
router.get('/getById/:id', requireAuth, logMiddleware, userController.getUserById);
